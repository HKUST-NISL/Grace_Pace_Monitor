...
class TurnOwnerFSM(StateMachine):
    ...
    def robot_taking_turn(self):
        ...
        return ( self.__latest_turn_action == self.__robot_take_turn_action_name )

    def robot_yielding_turn(self):
        #We know exactly what the robot is doing
        return ( self.__latest_turn_action == self.__robot_yield_turn_action_name )
    ...
    '''
        Wrapper
    '''
    def procTurnAction(self, latest_turn_action):
        self.__latest_turn_action = latest_turn_action
